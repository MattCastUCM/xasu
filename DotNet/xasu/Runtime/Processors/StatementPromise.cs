...
namespace Xasu.HighLevel
{
    public class StatementPromise
    {
        ...
        public StatementPromise CreateAndAddContextGroupingActivity(string id, string name, string description, string type)
        {
            ...
            return AddContextGroupingActivity(act);
        }
        ...
        public StatementPromise CreateAndAddContextParentActivity(string id, string name, string description, string type)
        {
            ...
            return AddContextParentActivity(act);
        }
        ...
        {
            return CreateAndAddContextCategoryActivity(id, "http://adlnet.gov/expapi/activities/profile");
        }
        ...
        public StatementPromise CreateAndAddContextCategoryActivity(string id, string typeUri = null)
        {
            ...
            return AddContextCategoryActivity(activity);
        }
        ...
        {
            var jObject = traceExtensions.ToJObject(TCAPIVersion.V103);
            ...
            catch (Exception ex)
            {
                ...
                {
                    XasuTracker.LogWarning("[STRICT=OFF] Error adding extensions to trace. Ignoring...");
                    // TODO: Test
