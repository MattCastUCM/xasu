...
namespace Xasu.HighLevel
{
    public class AccessibleTracker : AbstractSeriousGameHighLevelTracker<AccessibleTracker>
    {
        ...
        * *******************/
        ...
        /// Type = Accessible by default
        /// </summary>
        /// <param name="reachableId">Reachable identifier.</param>
        /// <param name="type">Reachable type.</param>
        public StatementPromise Accessed(string reachableId, AccessibleType type = AccessibleType.Accessible)
        {
        ...
        /// <param name="reachableId">Reachable identifier.</param>
        /// <param name="type">Reachable type.</param>
        public StatementPromise Skipped(string reachableId, AccessibleType type = AccessibleType.Accessible)
        {
            return Enqueue(new Statement
            {
