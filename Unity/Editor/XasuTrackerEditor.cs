...
namespace Xasu.Editor
{
    ...
    public class XasuTrackerEditor : UnityEditor.Editor
    {
        ...
        {
            return Application.isPlaying && XasuTracker.Status != null;
        }
        ...
        public override void OnPreviewGUI(Rect r, GUIStyle background)
        {
            ...
            GUI.Label(r, Newtonsoft.Json.JsonConvert.SerializeObject(XasuTracker.Status, Newtonsoft.Json.Formatting.Indented));
