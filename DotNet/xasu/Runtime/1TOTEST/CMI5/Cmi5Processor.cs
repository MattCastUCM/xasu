...
namespace Xasu.Processors
{
    public class Cmi5Processor : OnlineProcessor
    {
        ...
        public override async Task Init()
        {
            ...
            // Setup the context
            XasuTracker.DefaultContext = Cmi5Helper.Cmi5Allowed;
            XasuTracker.DefaultContextRegistrationId = (Guid)Cmi5Helper.Cmi5Context.registration;
        ...
        public override async Task Finalize(IProgress<float> progress)
        {
            ...
            {
                // TODO: Test
                ApplicationSettings.OpenURL(Cmi5Helper.ReturnURL.ToString());
            }
        }
