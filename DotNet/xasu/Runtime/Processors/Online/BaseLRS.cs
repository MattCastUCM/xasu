...
namespace Xasu
{
    public class BaseLRS : IAsyncLRS
    {
        public virtual string endpoint { get; set; }
        public virtual TCAPIVersion version { get; set; }
        public virtual IAuthProtocol auth { get; set; }
        public virtual IHttpRequestHandler requestHandler { get; set; }
        public virtual Dictionary<String, String> extended { get; set; } = new Dictionary<String, String>();

        public virtual AsyncPolicy policy { get; set; }

        public BaseLRS(string endpt)
        {
            endpoint = endpt;
        ...
        protected virtual async Task<HttpResponse> MakeAsyncRequest(HttpRequest req)
        {
            // Set URL
        ...
        protected  virtual async Task<HttpResponse> GetDocument(String resource, Dictionary<String, String> queryParams, Document document)
        {
        ...
        protected  virtual async Task<ProfileKeysLRSResponse> GetProfileKeys(String resource, Dictionary<String, String> queryParams)
        {
        ...
        protected  virtual async Task<LRSResponse> SaveDocument(String resource, Dictionary<String, String> queryParams, Document document)
        {
        ...
        protected  virtual async Task<LRSResponse> DeleteDocument(String resource, Dictionary<String, String> queryParams)
        {
            var r = new LRSResponse();
        ...
        protected  virtual async Task<StatementLRSResponse> GetStatement(Dictionary<String, String> queryParams)
        {
        ...
        {
            var r = new StatementLRSResponse();
            var req = new HttpRequest { resource = "statements" };
